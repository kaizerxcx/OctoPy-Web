    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(default=datetime.datetime(2021, 10, 11, 14, 53, 26, 144835))),
                ('isRead', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now=True)),
                ('isRead', models.BooleanField(default=False)),
                ('child_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_feedback', to='user.child')),
            ],
            options={
                'db_table': 'Feedback',
            },
